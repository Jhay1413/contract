...
exports.transactionQueryData = exports.transactionLogsData = exports.completeStaffWorkQuerySchema = exports.filesQuerySchema = void 0;
const zod_1 = require("zod");
const mutation_schema_1 = require("../users/mutation-schema");
...
exports.transactionQueryData = zod_1.z.object({
    ...
    dateReceived: zod_1.z.nullable(zod_1.z.string().datetime()).optional(),
    attachments: zod_1.z.array(exports.filesQuerySchema).optional(),
    forwarder: mutation_schema_1.AccountSchema.optional(),
    receiver: zod_1.z.nullable(mutation_schema_1.AccountSchema).optional(),
    attachment: zod_1.z.nullable(zod_1.z.array(exports.filesQuerySchema)).optional(),
